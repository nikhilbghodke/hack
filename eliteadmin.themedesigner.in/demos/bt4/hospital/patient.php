            ...
            <div class="container-fluid">
                ...
                <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td>".$row["id"]."</td><td>".$row["aadhaar"]."</td><td>".$row["name"]."</td><td>".$row["DOB"]."</td><td>".$row["gender"]."</td><td>".$row["phnumber"]."</td><td><form method='GET' action='patientEHR.php?id=".$row["id"]."'><input type='submit'>View EHR</button></form></td></tr>";
