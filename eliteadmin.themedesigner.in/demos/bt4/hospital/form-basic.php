...
<?php include("php/getOTP.php");?>
<!DOCTYPE html>
<html lang="en">


<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/hospital/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jan 2020 10:26:10 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Enter OTP generated on patients mobile.</h4>
                    </div>
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="php/sendOTP.php" method="POST">
                                    <div class="form-group">
                                        <input type="text" name="apiKey" value="<?php echo $response; ?>" style="display: none;"></input>
...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/hospital/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jan 2020 10:26:11 GMT -->
</html>